...
Type infer_types_of_block(Ast_Node *block, Ast_Function_Definition *function_definition, bool using_result, bool *unit_poisoned);
Type infer_type_of_expr(Ast_Node *n, Scope *scope, Ast_Function_Definition *function_definition, bool using_result, bool *unit_poisoned);
