...
Type_Info infer_types_of_block(Ast_Node *block, bool using_result, bool *unit_poisoned);
Type_Info infer_type_of_expr(Ast_Node *n, Scope *scope, bool using_result, bool *unit_poisoned);
